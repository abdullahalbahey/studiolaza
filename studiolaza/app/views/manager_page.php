        ...
        <div class="" style="display:flex; width:85%; justify-content: center;">
            <div class="content" style="display:flexbox; ">
                ...
                <div style="display:flex ; flex-direction: column;">
                    ...
                    LKR: <input readonly type="number" id="budget" name="budget" style="width:40% ; height:30px" value="<?php echo $data['bookingdetails'][0]->price; ?>">
                    <br>
                    <label width="width: 200px; display: inline-block;" for="budget"><strong>Amount paid: </strong> </label>
                    LKR: <input readonly type="number" id="budget" name="budget" style="width:40% ; height:30px" value="<?php echo $data['bookingdetails'][0]->balance; ?>">
                    <br>

                </div>

                <div style="text-align:center;">
                    <button class="button labelbox" style=" width:100%;" type="submit" name="submit"> Update </button>
                </div>
            </div>
