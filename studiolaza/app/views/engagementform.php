...
<body class="brownbox">
    ...
    <div class="middle_2 " style="display: flex; border-radius: 2%;  align-items: center; width:60%; margin: 6% auto;   background-color: white; border: 2.5px solid #dadce0; padding-bottom:120px">
        ...
        <form class="" style="display: flex;flex-direction: column; width: 90%;align-content: space-between;" action="<?php echo URLROOT; ?>/booknow/engagementform" method="post" enctype="multipart/form-data">
