...
<body class="brownbox" style="flex-direction: column; ">
    ...
    <div class="middle_2 signupFrm" id="backgroundIMG">
        ...
        <h2>HOMECOMING DETAILS</h2>

        <form class="form" style="display: flex;flex-direction: column; width: 90%;align-content: space-between;"action="<?php echo URLROOT; ?>/booknow/homecomingform" method="post" enctype="multipart/form-data">
