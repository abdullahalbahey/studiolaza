...
<body class="brownbox" style="flex-direction: column; ">
    ...
    <div class=" middle_2  signupFrm" id="backgroundIMG">
        ...
        <form class="form"  action="<?php echo URLROOT; ?>/customerbooking/weddingform" method="post" enctype="multipart/form-data">
            
            <h2>WEDDING FORM</h2><br>
            ...
            <div class="borderforcels">
                <div class="inputContainer" style="display:flex;direction:row;align-items: center;justify-content: space-between;">
                    ...
                    <label class="TickLabel" style="float:right" for="mainalbum">
                        30 000 LKR.
                        <input type="checkbox" id="mainalbum" name="mainalbum" checked disabled="disabled" value="Magazine_Album_[30sheets/60pgs]_">
                    </label>
                </div>
            ...
            <div class="borderforcels">
                <div class="inputContainer" style="display:flex;direction:row;align-items: center;justify-content: space-between;">
                    ...
                    <label class="TickLabel" style="float:right" for="familyalbum">
                        10 000 LKR.
                        <input type="checkbox" id="familyalbum" disabled="disabled" checked name="familyalbum" Value="Magazine_Family_Album-Photo_Cover_[8x12]_">
                    </label>
                </div>
            ...
            <button type="submit" name="savedetails" class="submitBtn"> <b>Update</b> </button></a>
            <button type="button" class="submitBtn" onclick="location.href='<?php echo URLROOT ?>/customerbooking/view_details_wedding'">Close</button>
